...
DismalModules.lazyVideo()


// Динамические круги в разделе "chart"
const bChartElems = document.querySelectorAll('.b-chart')

for (let i = 0; i < bChartElems.length; i++) {
	const bChart = bChartElems[i];
	const value = Number(bChart.querySelector('.b-chart__num-value span').innerText)
